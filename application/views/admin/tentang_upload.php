                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Menambahkan <small>Visi & Misi</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
...
<button class="btn btn-danger"><?php echo $this->session->flashdata('message');?></button>
   ...
   <div id="body">
      ...
      <?php endif; ?>
      <?=form_open_multipart('admin/dashboard/tentang_upload')?>

        

        <div class="form-group">
          <label for="nama">Visi</label>
          <textarea type="text" name="visi" > </textarea>
        </div>
        <div class="form-group">
          <label for="nama">Misi</label>
          <textarea type="text" name="misi" > </textarea>
        </div>
