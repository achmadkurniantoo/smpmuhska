...
<!-- ---------------------------------------------------------------------------------------------------- -->
          ...
          <div class="col-lg-12">
                ...
                <?=form_open_multipart('admin/dashboard/new_akademik_baru')?>
                ...
                <?php foreach ($newallkategoriakademik->result() as $key1) { ?>
                
                    <div class="radio-inline">
                      <label><input type="radio" value="<?=$key1->kategori?>" name="opsikategori"><?=$key1->kategori?></label>
                    </div>
