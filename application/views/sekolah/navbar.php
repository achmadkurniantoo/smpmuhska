...
<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="sekolah/index"><?=$title." ".$city?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href=<?php echo site_url().'/sekolah/index';?>>Beranda</a>
                    </li>
                    <li>
                        <a href=<?php echo site_url().'/sekolah/tentang';?>>Tentang</a>
                    </li> 
                    <li>
                        <a href=<?php echo site_url().'/sekolah/kontak';?>>Kontak</a>
                    </li>
                    <li class="dropdown">
                       ...
                       <!--   <li><a href="<?php echo base_url() ?>sekolah/artikel/berita">Berita Sekolah</a></li>
                        ...
                        -->
                          <?php foreach ($kategoris->result() as $kate) { ?>
                              <li><a href="sekolah/artikel/<?=$kate->kategori?>"> <?=$kate->kategori?></a></li>
                              <li role="separator" class="divider"></li>
                          <?php }?>
