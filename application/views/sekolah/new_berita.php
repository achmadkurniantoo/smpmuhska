...
<div class="container">
    ...
    <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Blog Post -->
                 <?php foreach ($akademik->result() as $key ) { ?>
                <!-- Title -->
                <h1><?=$key->judul?></h1>
                ...
                <!-- Date/Time -->
                 <div class="headpost">
                    ...
                    <p><span class="glyphicon glyphicon-time"></span> _POSTED ON <?=$key->tgl_posting?> KATEGORI <a href="<?php echo base_url().'sekolah/akademik/'. $key->kategori; ?>" rel="category tag"> <?=$key->kategori?></a></p>
                    </div>
                </div>
