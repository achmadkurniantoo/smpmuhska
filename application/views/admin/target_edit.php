                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Edit <small> Target Kompetensi</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard">Target Kompetensi</i> 
                            </li>
                        </ol>
                    </div>
                </div>
...
if($this->input->post()){
   ...
   <div id="body">
      ...
      <?=form_open_multipart('admin/dashboard/target_edit/'.$editTarget->id_target)?>


        <div class="form-group">
          <label for="target">Target Kompetensi</label>
