        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li >
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Setting <i class="fa fa-fw fa-caret-down"></i></a>
                ...
                <div id="container">
                   <div id="body">
                      ...
                      <?php if($images->num_rows() > 0) : ?>
                         ...
                         <div align="center"><?=anchor('panel_gallery/add','Add a new image',['class'=>'btn btn-primary'])?></div>
                         <hr />   
                         <div class="row">
                            ...
                            <div class="col-md-3">
                               <div class="thumbnail">
                                  ...
                                  <div class="caption">
                                     ...
                                     <p>
                                        <?=anchor('panel_gallery/edit/'.$img->id_images,'Edit',['class'=>'btn btn-warning', 'role'=>'button'])?>
                                        <?=anchor('panel_gallery/delete/'.$img->id_images,'Delete',['class'=>'btn btn-danger', 'role'=>'button','onclick'=>'return confirm(\'Are you sure?\')'])?>
                                     </p>
                                  </div>
                               </div>
                            </div>
