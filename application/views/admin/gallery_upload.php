                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Gallery <small>Upload Gambar</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
...
<button class="btn btn-danger"><?php echo $this->session->flashdata('message');?></button>
   <h1>Add New Image</h1>
    ...
    <div id="body">
      ...
      <?php endif; ?>
      <?=form_open_multipart('admin/dashboard/gallery_upload')?>
        ...
        <?=anchor('index.php/admin/dashboard/gallery','Cancel',['class'=>'btn btn-warning'])?>
