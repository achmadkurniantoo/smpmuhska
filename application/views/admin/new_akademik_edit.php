...
<!-- ---------------------------------------------------------------------------------------------------- -->
          ...
          <div class="col-lg-12">
                ...
                <?=form_open_multipart('admin/dashboard/new_akademik_edit/'.$newakademikbyid->id_akademik)?>

                <div class=" alert alert-success" >

                  <div class="form-group">
                        <label for="title">JUDUL BERITA / ARTIKEL</label>
                        <input type="text" class="form-control" name="title" value="<?=$newakademikbyid->judul?>"> 
                  </div>
                ...
                <div class="alert alert-success">
                    ...
                    <textarea  name="isi"> <?=$newakademikbyid->isi?></textarea>
